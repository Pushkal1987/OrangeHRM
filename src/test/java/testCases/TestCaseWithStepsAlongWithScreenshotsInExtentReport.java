...
public class TestCaseWithStepsAlongWithScreenshotsInExtentReport extends BaseClass{
	...
	public void loginWithValidCredentials() {
		...
		test = ExtentReportManager.extent.createTest("Started: TestCaseWithStepsAlongWithScreenshotsInExtentReport");
		...
		try {
            ...
            ExtentReportManager.logStepWithScreenshot(test,"Entered username: " + username);
            
            logger.info("Entering password: " + password);
            loginPage.enterPassword(password);
            ExtentReportManager.logStepWithScreenshot(test,"Entered password. " );
            logger.info("Clicking the login button...");
            loginPage.clickLogin();
            ExtentReportManager.logStepWithScreenshot(test,"Clicked on Login button." );	
            ...
            if (isTimeAtWorkExistdDisplayed==true) 
            {
            	...
            	ExtentReportManager.logStepWithScreenshot(test,"Login successful: Time at Work is displayed." );
			...
			} else 
			{
				...
				ExtentReportManager.logStepWithScreenshot(test,"Login failed: Time at Work is not displayed after login." );
			...
			ExtentReportManager.logStepWithScreenshot(test,"Login successful and Time at Work is displayed." );
		} catch (Exception e) {
			logger.error("Exception occurred while logging in with valid credentials: " + e.getMessage());
			ExtentReportManager.logStepWithScreenshot(test,"Exception occurred while logging in with valid credentials: " + e.getMessage());
			e.printStackTrace();
			Assert.fail("Test failed due to exception: " + e.getMessage());
		}

		logger.info("******* Finished: TC0003_VerifyMenuPanel : loginWithValidCredentials *********");
		ExtentReportManager.logStepWithScreenshot(test,"Finished: TC0003_VerifyMenuPanel : loginWithValidCredentials" );
	}
	...
	public void verifyLogoOnMenuPanel() {
		...
		ExtentReportManager.logStepWithScreenshot(test,"Started: TC0003_VerifyMenuPanel : verifyLogoOnMenuPanel" );
		...
		try 
		{
			...
			ExtentReportManager.logStepWithScreenshot(test,"Verifying if the logo is displayed on the menu panel..." );
			boolean isLogoDisplayed = menuPanel.isLogoDisplayed();
			if (isLogoDisplayed) {
				logger.info("Logo is displayed on the menu panel.");
				ExtentReportManager.logStepWithScreenshot(test,"Logo is displayed on the menu panel." );
				Assert.assertTrue(true);
			} else {
				logger.error("Logo is not displayed on the menu panel.");
				ExtentReportManager.logStepWithScreenshot(test,"Logo is not displayed on the menu panel." );
				Assert.fail("Logo is not displayed on the menu panel.");
			}
			logger.info("Logo on menu panel verified successfully.");
			ExtentReportManager.logStepWithScreenshot(test,"Logo on menu panel verified successfully." );
		} catch (Exception e) {
			logger.error("Exception occurred while verifying the logo on the menu panel: " + e.getMessage());
			ExtentReportManager.logStepWithScreenshot(test,"Exception occurred while verifying the logo on the menu panel: " + e.getMessage());
			e.printStackTrace();
			Assert.fail("Test failed due to exception: " + e.getMessage());
		}
		logger.info("******* Finished: TC0003_VerifyMenuPanel : verifyLogoOnMenuPanel *********");
		ExtentReportManager.logStepWithScreenshot(test,"Finished: TC0003_VerifyMenuPanel : verifyLogoOnMenuPanel" );
	}
	...
	public void verifyAllAvailableMenuOptionsOnMenuPanel(String menuName) {
		...
		ExtentReportManager.logStepWithScreenshot(test,"Started: TC0003_VerifyMenuPanel : verifyAllAvailableMenuOptionsOnMenuPanel" );
		...
		try {
			...
			ExtentReportManager.logStepWithScreenshot(test,"Verifying if the menu option '" + menuName + "' is displayed in the menu panel..." );
			if (isMenuDisplayed) 
			{
				logger.info("Menu option '" + menuName + "' is available in the menu panel.");
				ExtentReportManager.logStepWithScreenshot(test,"Menu option '" + menuName + "' is available in the menu panel." );
			...
			} else 
			{
				...
				ExtentReportManager.logStepWithScreenshot(test,"Menu option '" + menuName + "' is not available in the menu panel." );
			...
			ExtentReportManager.logStepWithScreenshot(test,"Exception occurred while verifying the menu options: " + e.getMessage());
			e.printStackTrace();
			Assert.fail("Test failed due to exception: " + e.getMessage());
		}
		logger.info("******* Finished: TC0003_VerifyMenuPanel : verifyAllAvailableMenuOptionsOnMenuPanel *********");
		ExtentReportManager.logStepWithScreenshot(test,"Finished: TC0003_VerifyMenuPanel : verifyAllAvailableMenuOptionsOnMenuPanel" );
	}
	...
	public void verifySearchBoxFunctionality() {
		...
		ExtentReportManager.logStepWithScreenshot(test,"Started: TC0003_VerifyMenuPanel : verifySearchBoxFunctionality" );
		...
		try 
		{
			...
			ExtentReportManager.logStepWithScreenshot(test,"Retrieving the expected menu name from properties file..." );
			...
			ExtentReportManager.logStepWithScreenshot(test,"Entering the expected menu name '" + expectedMenuName + "' in the search box..." );
			...
			ExtentReportManager.logStepWithScreenshot(test,"Retrieving all menu names from the menu panel..." );
			...
			ExtentReportManager.logStepWithScreenshot(test,"Verifying if the expected menu name '" + expectedMenuName + "' is present in the menu panel..." );
			if (actualMenuName.contains(expectedMenuName)) {
				...
				ExtentReportManager.logStepWithScreenshot(test,"Search box functionality is working correctly. Expected menu: '" +expectedMenuName+"', Found menu: '" + actualMenuName+"'." );
				...
				ExtentReportManager.logStepWithScreenshot(test,"Search box functionality failed. Expected menu '" + expectedMenuName + "' not found." );
			...
			ExtentReportManager.logStepWithScreenshot(test,"Exception occurred while verifying the search box functionality: " + e.getMessage());
			e.printStackTrace();
			Assert.fail("Test failed due to exception: " + e.getMessage());
		}

		logger.info("******* Finished: TC0003_VerifyMenuPanel : verifySearchBoxFunctionality *********");
		ExtentReportManager.logStepWithScreenshot(test,"Finished: TC0003_VerifyMenuPanel : verifySearchBoxFunctionality" );
	}
